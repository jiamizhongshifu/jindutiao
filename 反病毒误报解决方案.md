...
**提交说明模板**:
```
Application Name: Gaiya (盖亚)
Version: 1.4.0
Developer: Gaiya Team
Website/Repository: https://github.com/jiamizhongshifu/jindutiao

Description:
Gaiya is an open-source desktop time visualization application built with Python and PySide6.

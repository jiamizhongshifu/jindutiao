...
[![Version](https://img.shields.io/badge/version-1.4-yellow.svg)](https://github.com) ⚠️
[![License](https://img.shields.io/badge/license-MIT-orange.svg)](LICENSE)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20Linux%20%7C%20macOS-lightgrey.svg)](https://github.com)

**当前版本: v1.4** | 最后更新: 2025-01-XX ⚠️ 存在已知问题
...
- ⚠️ **已知问题,尚未修复**
- 已尝试多种修复方案但问题仍存在
- 详细说明请参考 [BUG修复说明_v1.4.md](BUG修复说明_v1.4.md)
...
**已尝试的修复:**
- 移除 `QApplication.processEvents()` 调用
- 延迟主题应用时机
- 调整窗口显示时机
- 优化主题管理器初始化流程

**排查建议:**
- 查看 `pydaybar.log` 日志文件,确认卡死发生在哪个步骤
- 尝试使用 `python main.py` 直接运行,确认是否是打包问题
- 检查 `themes.json` 文件格式是否正确

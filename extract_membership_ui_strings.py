...
def extract_chinese_strings():
    ...
    # 写入结果到文件
    with open('membership_ui_strings.txt', 'w', encoding='utf-8') as f:
        f.write(f"=== membership_ui.py 中文字符串提取 ===\n")
    ...
    print(f"结果已保存到 membership_ui_strings.txt")
